  ...
  return (
    ...
    >
      ...
      <span className={LINE}>
        ...
        {/* Kept through the merge: the incoming branch's cell geometry replaced
            this line rather than moving it. It is the only thing on the row
            that says work has been HANDED IN — a manager scanning the list can
            otherwise not tell a task being worked on from one waiting on them,
