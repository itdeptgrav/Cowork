...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    source:
      "derive() priority order: emergency > break > share state; the start instants travel from cowork_duty_status via readDutySnapshot so every device shares one origin",
  },
  {
