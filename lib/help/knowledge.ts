...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    related: ["task-cross-department", "task-budget-vs-deadline-rights"],
    source:
  ...
  },
  {
    ...
    source:
      "lib/auth/priority.ts — selfReorderRefusal; changePriority + #applyOrder in lib/repositories/mock/index.ts; PriorityAckGate",
  },
  {
    ...
    source:
      "lib/rules/tasks/deadlineFeasibility.ts \u2014 calculateDeadlineFeasibility; previewDeadlineFeasibility in lib/repositories/legacy/index.ts; components/features/tasks/FeasibilityPreview.tsx",
  },
  {
    id: "task-cancel",
    category: "tasks",
