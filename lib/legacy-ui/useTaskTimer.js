...
import { doc, setDoc, onSnapshot, collection } from "@/lib/legacy/firestoreClient";
...
async function logTimerEvent(employeeId, type, taskId, taskTitle, reason = null) {
    try {
        const { addDoc, collection: col, serverTimestamp } = await import("@/lib/legacy/firestoreClient");
